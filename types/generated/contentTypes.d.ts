...
export interface ApiAboutAbout extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hobby: Attribute.Text & Attribute.Required;
    imageHobby: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    coverResource: Attribute.String & Attribute.Required;
    coverResourceUrl: Attribute.String & Attribute.Required;
...
export interface ApiProjectHostProjectHost extends Schema.CollectionType {
  collectionName: 'project_hosts';
  info: {
    singularName: 'project-host';
    pluralName: 'project-hosts';
    displayName: 'ProjectHost';
    description: '';
  };
  options: {
    draftAndPublish: true;
